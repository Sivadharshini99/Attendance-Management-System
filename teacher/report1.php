  ...
  <div class="content">
   ...
   <?php
    ...
    if(isset($_POST['sr_btn'])){
     ...
     $single = mysql_query("select stat_id,count(*) as countP from attendance where attendance.stat_id='$sr_id' and attendance.class = '$class' and attendance.st_status='Present'");
    ...
    if(isset($_POST['sr_date'])){
     ...
     $all_query = mysql_query("select * from attendance where reports.stat_date='$sdate' and reports.class = '$class'");
