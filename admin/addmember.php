    ...
    if(isset($_POST['std'])){
      ...
      //students data insertion to database table "students"
        ...
        if(isset($_POST['tcr'])){
          ...
          $res = mysql_query("insert into teachers(tc_id,tc_name,tc_cls,tc_sub,tc_email) values('$_POST[tc_id]','$_POST[tc_name]','$_POST[tc_cls]','$_POST[tc_sub]','$_POST[tc_email]')");
...
<br><br><br>
  <div class="rowtwo" id="teacher">
      ...
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Class</label>
          <div class="col-sm-7">
            <input type="text" name="tc_cls"  class="form-control" id="input1" placeholder="class ex. 11B" />
          </div>
      </div>

      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Subject</label>
          <div class="col-sm-7">
            <input type="text" name="tc_sub"  class="form-control" id="input1" placeholder="subject ex.English" />
          </div>
      </div>
