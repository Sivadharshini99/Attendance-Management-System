...
<div class="content">
    ...
    <h3>Recover your password</h3>
      ...
      <input type="submit" class="btn btn-danger col-md-2 col-md-offset-10" value="Go" name="reset" />
    </form>
      ...
      <?php
          ...
          //$rows = 0;
         //$all_query = mysql_query("select password from students where st_email = '$test'");
          //$rows = mysql_num_rows($all_query);
